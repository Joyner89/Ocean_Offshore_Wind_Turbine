...
export class Ocean implements CreateSceneClass {
    ...
    private _checkSupport(): boolean {
        ...
        const textNOk = "**WebGPU compute shaders are not available in this browser context. If you are opening this page from another LAN machine through http://IP:8080, Chrome treats that address as an insecure origin and disables WebGPU. Open it on localhost, use HTTPS, or start Chrome with --unsafely-treat-insecure-origin-as-secure=http://IP:8080.**";
