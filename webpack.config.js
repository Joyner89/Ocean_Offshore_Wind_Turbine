...
var httpsKeyPath = path.join(__dirname, "certs", "ocean-demo-local.key");
var httpsCertPath = path.join(__dirname, "certs", "ocean-demo-local.crt");
var hasHttpsCertificate = fs.existsSync(httpsKeyPath) && fs.existsSync(httpsCertPath);
